      ...
      <div className="absolute top-4 right-4 z-[1000] bg-gray-900/90 backdrop-blur-md p-1.5 rounded-xl border border-gray-700 flex space-x-1 shadow-lg">
        <button 
          ...
          className={`px-4 py-2 text-sm font-bold rounded-lg transition-all flex items-center gap-2 ${
            mapMode === 'heatmap' ? 'bg-orange-600 text-white shadow-md' : 'text-gray-400 hover:text-white hover:bg-gray-800'
          }`}
        >
        ...
        <button 
          ...
          className={`px-4 py-2 text-sm font-bold rounded-lg transition-all flex items-center gap-2 ${
            mapMode === 'points' ? 'bg-blue-600 text-white shadow-md' : 'text-gray-400 hover:text-white hover:bg-gray-800'
          }`}
        >

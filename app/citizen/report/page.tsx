...
export default function CitizenIncidentReportPage() {
    ...
    const handleMapClick = (lat: number, lng: number) => {
        if (activeTab === 'report') {
            ...
            showToast('info', 'HƯỚNG DẪN', "Vui lòng chuyển sang tab 'Gửi Báo Cáo' để chọn vị trí báo cáo sự cố trên bản đồ.");
        }
    };
    ...
    const renderFormAndHistory = () => (
        <>
            ...
            {/* Tab Navigation */}
            <div className="flex border-b border-slate-800 mb-4 bg-slate-950/40 rounded-lg p-1 shrink-0">
                <button
                    type="button"
                            ...
                            <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800 space-y-3">
                                <div className="flex justify-between items-center text-xs">
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold rounded-lg text-[10px] flex items-center gap-1 active:scale-95 transition-all animate-none"
                                    >
                                ...
                                <p className="text-[10px] text-slate-500 text-center italic">
                                    Mẹo: Nhấp chuột trực tiếp lên bản đồ để điều chỉnh vị trí chính xác.
                                </p>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 flex-1">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Ví dụ: Vết sạt rộng khoảng 5m cản trở hoàn toàn lối đi, ngập úng cao..."
                                    rows={3}
                                    className="w-full p-2.5 bg-slate-950 border border-slate-700 text-slate-100 text-sm font-semibold rounded-xl focus:ring-2 focus:ring-amber-500 outline-none"
                                    required
                                />
